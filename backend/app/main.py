...
from app.routers.descanso import router as descanso_router  # nuevo router para gestionar descansos

app = FastAPI(
    title="Teleprogreso S.A. — API",
    description=(
        "API REST para supervision de personal, gestion de tareas "
        "y control de asistencia. Todos los endpoints (excepto /auth/login) "
        "requieren autenticacion JWT mediante Bearer token."
    ),
    version="1.0.0",
